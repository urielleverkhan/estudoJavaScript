; (function () {
    ...
    // Array.from(arrTasks).forEach((tasks, i) => {
    //     arrInstancesTasks[i] = new Task(tasks.name, tasks.completed, tasks.createdAt, tasks.updatedAt)
    // })
